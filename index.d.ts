...
export function         getTokens(row: number): TokenInfo[];
        ...
        **/
export function         getTokenAt(row: number, column: number): TokenInfo;
...
export function         execCommand(command:string, args?: any): void;
         ...
         **/
export function         setOption(optionName: any, optionValue: any): void;

        /**
         * Sets Configuration Options
         **/
export function         setOptions(keyValueTuples: any): void;

        /**
         * Get a Configuration Option
         **/
export function         getOption(name: any):any;
